...
function setLanguage(lang) {
  ...
  if (heroDesc1) {
    heroDesc1.textContent = isEn ? 'This repository aggregates trusted Root CA certificates from Debian repositories and Mozilla trust stores, suitable for updating legacy browsers and system certificate stores.' : '此处收集来自 Debian Repo 和 Mozilla PEM 证书链的根证书颁发机构证书，可用于旧式浏览器和系统证书库更新。';
  }
